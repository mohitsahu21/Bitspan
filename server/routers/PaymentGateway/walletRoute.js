...
router.post("/offlineRechargeAndUpdateWallet", authenticateToken, offlineRechargeAndUpdateWallet);
router.post("/dthConnectionAndUpdateWallet", authenticateToken, dthConnectionAndUpdateWallet);
