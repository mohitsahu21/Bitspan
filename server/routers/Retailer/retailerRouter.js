...
const {
  ...
  buyCoupon,
  getCoupon,
  getAddMoneyToWalletOnline, update_bankidForm,
...
router.get("/getApplyOfflineFormByid/:id", authenticateToken, getApplyOfflineFormByid);
router.get("/getApplyOfflineForm", getApplyOfflineForm);
router.put("/updateApplyOfflineForm/:id", authenticateToken, updateApplyOfflineForm);
...
router.get("/getApiRechargeData/:userId", authenticateToken, getApiRechargeData);
...
// router.get("/nsdl-trans-new-requst", authenticateToken, nsdlTransactionNewRequest);
router.get(
  "/nsdl-trans-new-requst/:id",
  authenticateToken,
  nsdlTransactionNewRequest
);
// router.get("/nsdl-trans-correction", authenticateToken, nsdlTransactionCorrection);
router.get(
...
router.get("/getSelectedServices/:user_id", authenticateToken, getSelectedServices);
...
router.get("/getApiPostRechargeData/:userId", authenticateToken, getApiPostRechargeData);
router.get("/getApiDTHRechargeData/:userId", authenticateToken, getApiDTHRechargeData);
router.get(
  "/getApiEletricityRechargeData/:userId", authenticateToken,
  getApiEletricityRechargeData
);
router.get(
  "/getApiBroadbrandRechargeData/:userId", authenticateToken,
  getApiBroadbrandRechargeData
);
...
router.put("/UpdateVerifyDistrictForm", authenticateToken, UpdateVerifyDistrictForm);
router.get("/getVerifyEdistrict/:userId", authenticateToken, getVerifyEdistrict);
...
router.get("/getAddMoneyToWalletOnline/:userId", authenticateToken, getAddMoneyToWalletOnline);
...
router.put("/update_bankidForm", authenticateToken, upload.fields([
  { name: "attached_photo", maxCount: 1 },
  { name: "attached_kyc", maxCount: 10 },
  { name: "bank_passbook", maxCount: 1 },
  { name: "shop_photo", maxCount: 1 },
...
router.get("/getDTHConnectionData/:userId", authenticateToken, getDTHConnectionData);
router.get("/getOfflineRecharge/:userId/:rechargeType", authenticateToken, getOfflineRecharge);
router.get("/getOfflineDTHConnection/:userId", authenticateToken, getOfflineDTHConnection);
router.get("/getAllServicesList", authenticateToken, getAllServicesList);
router.get(
  "/getAllMonthCommission/:userId", authenticateToken,
  getAllMonthCommission
);
router.get(
  "/getTodaysCommission/:userId", authenticateToken,
  getTodaysCommission
);
router.get(
  "/getUserNotification/:userId", authenticateToken,
  getUserNotification
);
router.get(
  "/getAllMonthRecharge/:userId", authenticateToken,
  getAllMonthRecharge
);
router.get(
  "/getAllMonthRechargeOffline/:userId", authenticateToken,
  getAllMonthRechargeOffline
);
router.get(
  "/getTodaysRechargeOffline/:userId", authenticateToken,
  getTodaysRechargeOffline
);
router.get(
  "/getTodaysRecharge/:userId", authenticateToken,
  getTodaysRecharge
);
