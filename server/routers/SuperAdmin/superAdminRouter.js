...
const { addPackage, getPackages, editPackage, deletePackage, getPendingUsers, approveUser, rejectUser, getActiveUsers, deactivateUser, activateUser, getdeactiveUsers, getUserRelations, getAllUsers, getPendingPaymentUsers, markPaymentComplete, getUserIdPriceList, addUserIdPrice, updateUserIdPrice, getSuperAdminEmployee, complainGetData,getPendingComplaintData, resolveComplaint, getApplyOfflineForm, ApproveOfflineForm,markForEditOfflineForm, SuccessOfflineForm, rejectOfflineForm, getPANOfflineForm, ApprovePANOfflineForm,markForEditPANOfflineForm,SuccessPANOfflineForm, rejectPANOfflineForm, getBankIdForm, ApproveBankIdForm,markForEditBankIdForm,SuccessBankIdForm, rejectBankIdForm, getEdistrictForms, ApproveEdistrictForm,markForEditEdistrictForm,SuccessEdistrictForm, rejectEdistrictForm, getOfflineRecharge, ApproveOfflineRecharge, rejectOfflineRecharge, getOfflineDTHConnection, ApproveOfflineDTHConnection,markForEditOfflineDTHConnection,SuccessOfflineDTHConnection, rejectOfflineDTHConnection, getWalletWithdrawRequests, ApproveWalletWithdrawRequests, rejectWalletWithdrawRequests, getPendingWalletWithdrawRequests, getWalletTransactions, getPendingWalletAddMoneyRequests, ApproveWalletAddMoneyRequests, rejectWalletAddMoneyRequests, getAllWalletAddMoneyRequests, getAllApiList, ActiveApi, DeactiveApi, getAllServicesList, ActiveServices, DeactiveServices, getSuperAdminSettings, UpdateGenralSetting, UpdateSocialLinkSetting, UpdateLogoImageSetting, UpdateHomePageSetting, getUserNotification, UpdateUserNotification, UpdateSAWebsiteJoiningPrice, AddWalletAddMoneyDirect, WithdrawWalletAddMoneyDirect, getBuyUserIdSummary, getVerifyEdistrictForms, ApproveVerifyEdistrictForm,markForEditVerifyEdistrictForm,SuccessVerifyEdistrictForm, rejectVerifyEdistrictForm, getSambalForms, ApproveSambalForm,markForEditSambalForm,SuccessSambalForm, rejectSambalForm ,getOnlineRecharge,getOnlineDthConnection,getPanCouponRequests,approvePanCouponRequest,rejectPanCouponRequest,getUserRelationData,changeUserWhiteLabel,changeUserDistributor,changeUserSuperDistributor,ChangeUserInfo,getOnlinePanApplyData,getOnlinePanCorrectionData,getTodayWalletTransactions,getDTHConnectionPlans,CreateDTHConnectionPlans,EditDTHConnetionPlans,DeleteDTHConnetionPlans,getPendingOfflineRecharge ,getPendingApplyOfflineForm,getPendingPANOfflineForm,getPendingBankIdForm,getPendingEdistrictForms,getPendingSambalForms,getPendingVerifyEdistrictForms,getPendingPanCouponRequests,getUserPackageDetails,
    CreditCommission,
    addCommissionEntry,
    getCommissionEntry,
    ...
    SuccessNSDLForm,
    rejectNSDLForm,
    SuccessNSDLCorrectionForm, rejectNSDLCorrectionForm,getSuperAdminWebsiteJoinUsers,
...
router.post("/addUserIdPrice" ,authenticateToken, addUserIdPrice );
...
router.get("/getWhiteLabelWebisiteJoinUsers",authenticateToken, getWhiteLabelWebisiteJoinUsers);
router.post("/AddCommisionForWhiteLabelJoinUser",authenticateToken, AddCommisionForWhiteLabelJoinUser);
router.put("/SuccessNSDLForm",authenticateToken, SuccessNSDLForm);
router.put("/rejectNSDLForm",authenticateToken, rejectNSDLForm);
router.put("/SuccessNSDLCorrectionForm",authenticateToken, SuccessNSDLCorrectionForm);
router.put("/rejectNSDLCorrectionForm",authenticateToken, rejectNSDLCorrectionForm);
router.get("/getSuperAdminWebsiteJoinUsers",authenticateToken,getSuperAdminWebsiteJoinUsers);
router.get("/getWalletToWalletTransfer",authenticateToken,getWalletToWalletTransfer);
