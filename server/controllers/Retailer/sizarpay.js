...
.catch((error) => {
  ...
  "M.P. Paschim Kshetra Vidyut Vitaran Company Ltd" : { code: "342", category: "Electricity" },
  "M.P. Poorv Kshetra Vidyut Vitaran Company Ltd (RURAL)" : { code: "341", category: "Electricity" },
  "M.P. Poorv Kshetra Vidyut Vitaran Company Ltd (URBAN)" : { code: "378", category: "Electricity" },
...
const sizarpayRecharge = (req, res) => {
  ...
  WHERE api_name = 'Sizar Pay' AND operator_name = ? AND status = 'Active' 
  LIMIT 1
`;
...
//           const formattedOrderId = `RES${String(autoGeneratedOrderId).padStart(6, "0")}`;
...
//         SPKey: operatorDetails.code,
//         ApiRequestID: orderid,
//         GEOCode : "77.5945627,12.9715987",
//         // CustomerNumber : "9806324244",
//         Pincode : "482002",
//         Format: "1",
//       }).then((rechargeData) => {
