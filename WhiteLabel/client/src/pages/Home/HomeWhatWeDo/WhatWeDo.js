            ...
            <div className="tab-content" id="price-tab-content">
              ...
              >
                <div className="row">
                  ...
                  <SingleDo
                    title="RETAILER, DISTRIBUTOR & SUPER DISTRIBUTOR"
                    description="A Retailer can start a PAN center with minimum investment only.Retailer can makes unlimited PAN cards through proper channel. A Distributor can makes unlimited PAN cards.He/She can create unlimited Retailers with low cost investment only."
                    active=""
                  />
                  <SingleDo
                    title="PAN CARD WHITE LABEL"
                    description=" We are providing pan card white label portal for your business. Here you can create unlimited pan card agent, pan card Super distributor &amp; distributor with full admin control panel. You can upload your company logo. If you want to business with pan card white label then TEST is best for your company. "
                  />
                </div>
              </div>
            </div>
