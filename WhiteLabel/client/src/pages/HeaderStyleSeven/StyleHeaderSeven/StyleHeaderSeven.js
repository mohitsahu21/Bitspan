      ...
      <header>
        <div className="header__area p-relative header__transparent">
          ...
          <div
            ...
            className={
              stickyMenu
                ? "sticky header__bottom black-bg"
                : "header__bottom black-bg"
            }
          >
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6">
                  <div className="logo">
                    <NavLink to="/">
                      ...
                      <h1 className="text-light">Bitspan.in</h1>
                    </NavLink>
                  </div>
                  <div className="logo-gradient">
                    <NavLink to="/">
                      {/* <img src="assets/img/logo/logo-gradient.png" alt="logo"/> */}
                      <h1 className="text-dark">Bitspan.in</h1>
                    </NavLink>
                  </div>
                </div>
                <div className="col-xl-9 col-lg-9 col-md-6 col-sm-6 col-6">
                  <div className="header__bottom-right d-flex justify-content-end align-items-center">
                    ...
                    <div className="header__btn d-none d-sm-block d-lg-none d-xl-block ml-50">
                      <Link
                        to="/contact"
                        className="z-btn z-btn-white z-btn-white-2 z-btn-white-3"
                      >
                        Get a Quote
                      </Link>
                    </div>
