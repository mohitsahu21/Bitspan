   ...
   return (
      <>
         <div className="col-xl-4 col-lg-4 col-md-6">
            <div className={`homeTwoDo__item ${active && active} p-relative transition-3 text-center fix mb-30`}>
               <div className="homeTwoDo__shape transition-3 p-absolute">
                  <img src="assets/img/icon/price/triangle.png" alt=""/>
               </div>
               <div className="homeTwoDo__inner p-relative">
                  <p className='fs-4'>{title}</p>
                  {/* <div className="price__tag mb-45">
                     <h2>{`₹${price}`}</h2>
                     <span>Per month</span>
                  </div> */}
                  <div className="homeTwoDo__features text-start mb-30">
                  <ul>
