                      ...
                      <div className="card card-1">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">Recharge</h4> </div>
                      ...
                      <div className="card card-3">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">Purchase</h4> </div>
                      ...
                      <div className="card card-4">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">Raise Query</h4> </div>
                      ...
                      <div className="card card-1">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">Track Application</h4> </div>
                      ...
                      <div className="card card-2">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">UTIITSL</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-3">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Photo & Signature</p>
                            <h4 className="px-2 my-0">Cropping Tool</h4> </div>
                      ...
                      <div className="card card-4">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">Wallet</h4> </div>
                      ...
                      <div className="card card-1">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">E-KYC Application</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-2">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Recharge Today</p>
                            <h4 className="px-2 my-0">0 - (Rs. 0)</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-3">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Recharge Month</p>
                            <h4 className="px-2 my-0">0 - (Rs. 0)</h4> </div>
                      ...
                      <div className="card card-4">
                        <div className="d-flex">
                          ...
                          <div className="d-flex flex-column cardtext">
                            ...
                            <h4 className="px-2 my-0">(Rs. 250/-)</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-1">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Today's Coupon Bought</p>
                            <h4 className="px-2 my-0">12</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-2">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Today Commission</p>
                            <h4 className="px-2 my-0">0</h4> </div>
                    ...
                    <div className="col-lg-4 col-8 col-sm-8   d-flex justify-content-center my-3 p-0">
                      <div className="card card-3">
                        <div className="d-flex">
                          ...
                          <div></div>
                          <div className="d-flex flex-column cardtext">
                            <p className="mb-0 px-2 my-0 fs-6">Month Commission</p>
                            <h4 className="px-2 my-0">0</h4> </div>
...
const Wrapper = styled.div`
  ...
  .card-1{
    background-image: linear-gradient( 91.3deg,  rgba(240,73,207,1) 15.7%, rgba(186,90,238,1) 74.1% );
  }
