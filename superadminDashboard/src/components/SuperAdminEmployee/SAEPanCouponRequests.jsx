  ...
  const CouponCommission = async (
    ...
    try {
      if (retailerPackage.PAN_Card_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.UTI_PAN_Coupon_Commission)) /
          100;
      } else {
        retailerCommAmount =
          quantity * parseFloat(retailerPackage.UTI_PAN_Coupon_Commission);
      }
      ...
      if (distributor && distributorPackage) {
        if (distributorPackage.PAN_Card_Commission_Type == "Percentage") {
          distributorCommAmount =
            (amount *
              parseFloat(distributorPackage.UTI_PAN_Coupon_Commission)) /
            100;
        } else {
          distributorCommAmount =
            quantity * parseFloat(distributorPackage.UTI_PAN_Coupon_Commission);
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (superDistributorPackage.PAN_Card_Commission_Type == "Percentage") {
          superDistributorCommAmount =
            (amount *
              parseFloat(superDistributorPackage.UTI_PAN_Coupon_Commission)) /
            100;
        } else {
          superDistributorCommAmount =
            quantity *
      ...
      if (white_lable && whiteLablePackage) {
        if (whiteLablePackage.PAN_Card_Commission_Type == "Percentage") {
          whiteLableCommAmount =
            (amount * parseFloat(whiteLablePackage.UTI_PAN_Coupon_Commission)) /
            100;
        } else {
          whiteLableCommAmount =
            quantity * parseFloat(whiteLablePackage.UTI_PAN_Coupon_Commission);
        }
      }
...
export default SAEPanCouponRequests;
