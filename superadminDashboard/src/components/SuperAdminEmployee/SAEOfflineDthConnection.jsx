  ...
  const handlesubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        "https://2kadam.co.in/api/auth/superAdmin/ApproveOfflineDTHConnection",
...
const SASuccessModel = ({ item, setShowSuccessModel, setIsRefresh }) => {
  ...
  //     setLoading(true);
  //     const response = await axios.put(
  //       "https://2kadam.co.in/api/auth/superAdmin/SuccessOfflineDTHConnection",
  //       // "https://2kadam.co.in/api/auth/superAdmin/resolveComplaint",
  //       formData,
  //       {
  //         headers: {
  ...
  const DthConnectionComm = async (
    ...
    try {
      if (
        retailerPackage.Offline_New_DTH_Connection_Commission_Type ==
        "Percentage"
      ) {
        if (operatorName == "Dish TV") {
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.Off_Dish_TV_New_DTH_Connection_Commission
              )) /
            100;
          ...
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.Off_Tata_Sky_New_DTH_Connection_Commission
              )) /
            100;
          ...
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.Off_Videocon_New_DTH_Connection_Commission
              )) /
            100;
          ...
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.Off_Sun_Direct_New_DTH_Connection_Commission
              )) /
            100;
          ...
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.Off_Airtel_New_DTH_Connection_Commission
              )) /
            100;
        }
      } else {
      ...
      if (distributor && distributorPackage) {
        if (
          distributorPackage.Offline_New_DTH_Connection_Commission_Type ==
          "Percentage"
        ) {
          if (operatorName == "Dish TV") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.Off_Dish_TV_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Tata Sky") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.Off_Tata_Sky_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Videocon") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.Off_Videocon_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Sun Direct") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.Off_Sun_Direct_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Airtel DTH") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.Off_Airtel_New_DTH_Connection_Commission
                )) /
              100;
          }
        } else {
      ...
      if (superDistributor && superDistributorPackage) {
        if (
          superDistributorPackage.Offline_New_DTH_Connection_Commission_Type ==
          "Percentage"
        ) {
          if (operatorName == "Dish TV") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.Off_Dish_TV_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Tata Sky") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.Off_Tata_Sky_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Videocon") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.Off_Videocon_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Sun Direct") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.Off_Sun_Direct_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Airtel DTH") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.Off_Airtel_New_DTH_Connection_Commission
                )) /
              100;
          }
        } else {
      ...
      if (white_lable && whiteLablePackage) {
        if (
          whiteLablePackage.Offline_New_DTH_Connection_Commission_Type ==
          "Percentage"
        ) {
          if (operatorName == "Dish TV") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.Off_Dish_TV_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Tata Sky") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.Off_Tata_Sky_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Videocon") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.Off_Videocon_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Sun Direct") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.Off_Sun_Direct_New_DTH_Connection_Commission
                )) /
              100;
          } else if (operatorName == "Airtel DTH") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.Off_Airtel_New_DTH_Connection_Commission
                )) /
              100;
          }
        } else {
...
const SARejectModel = ({ item, setShowRejectModel, setIsRefresh }) => {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        "https://2kadam.co.in/api/auth/superAdmin/rejectOfflineDTHConnection",
        // "https://2kadam.co.in/api/auth/superAdmin/resolveComplaint",
        formData,
        {
          headers: {
...
const SAEOfflineDthConnection = () => {
  ...
  const fetchOfflineForm = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://2kadam.co.in/api/auth/superAdmin/getOfflineDTHConnection",
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
...
export default SAEOfflineDthConnection;
