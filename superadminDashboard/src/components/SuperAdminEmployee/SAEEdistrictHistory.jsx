...
const SASuccessModel = ({ item, setShowSuccessModel, setIsRefresh }) => {
  ...
  //   }
  // };
  const EdistrictCommission = async (
    retailer,
    distributor,
    superDistributor,
    white_lable,
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        if (application_type == "income") {
          retailerCommAmount =
            (amount *
              parseFloat(retailerPackage.eKYC_Income_Certificate_Commission)) /
            100;
        } else {
          retailerCommAmount =
            (amount *
              parseFloat(
                retailerPackage.eKYC_Domicile_Certificate_Commission
              )) /
            100;
        }
      } else {
        if (application_type == "income") {
          retailerCommAmount = parseFloat(
            retailerPackage.eKYC_Income_Certificate_Commission
          );
        } else {
          retailerCommAmount = parseFloat(
            retailerPackage.eKYC_Domicile_Certificate_Commission
        ...
        if (
          ...
          if (application_type == "income") {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.eKYC_Income_Certificate_Commission
                )) /
              100;
          } else {
            distributorCommAmount =
              (amount *
                parseFloat(
                  distributorPackage.eKYC_Domicile_Certificate_Commission
                )) /
              100;
          }
        } else {
        ...
        if (
          ...
          if (application_type == "income") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.eKYC_Income_Certificate_Commission
                )) /
              100;
          } else {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.eKYC_Domicile_Certificate_Commission
                )) /
              100;
          }
        } else {
        ...
        if (
          ...
          if (application_type == "income") {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.eKYC_Income_Certificate_Commission
                )) /
              100;
          } else {
            whiteLableCommAmount =
              (amount *
                parseFloat(
                  whiteLablePackage.eKYC_Domicile_Certificate_Commission
                )) /
              100;
          }
        } else {
    ...
    try {
      ...
      if (data.data) {
        ...
        if (item.samagar == "ekyc") {
          result = await EdistrictCommission(
            retailer,
            distributor,
            superDistributor,
            white_lable,
...
export default SAEEdistrictHistory;
