    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        if (PAN_Type == "Physical") {
          retailerCommAmount =
            (amount *
              parseFloat(retailerPackage.offline_P_PAN_Card_Commission)) /
            100;
        } else {
          retailerCommAmount =
            (amount *
              parseFloat(retailerPackage.offline_E_PAN_Card_Commission)) /
            100;
        }
      } else {
        if (PAN_Type == "Physical") {
          retailerCommAmount = parseFloat(
            retailerPackage.offline_P_PAN_Card_Commission
          );
        } else {
          retailerCommAmount = parseFloat(
            retailerPackage.offline_E_PAN_Card_Commission
          );
        }
      }
        ...
        if (
          ...
          if (PAN_Type == "Physical") {
            distributorCommAmount =
              (amount *
                parseFloat(distributorPackage.offline_P_PAN_Card_Commission)) /
              100;
          } else {
            distributorCommAmount =
              (amount *
                parseFloat(distributorPackage.offline_E_PAN_Card_Commission)) /
              100;
          }
        } else {
          if (PAN_Type == "Physical") {
            distributorCommAmount = parseFloat(
              distributorPackage.offline_P_PAN_Card_Commission
            );
          } else {
            distributorCommAmount = parseFloat(
              distributorPackage.offline_E_PAN_Card_Commission
            );
          }
        }
      }
        ...
        if (
          ...
          if (PAN_Type == "Physical") {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.offline_P_PAN_Card_Commission
                )) /
              100;
          } else {
            superDistributorCommAmount =
              (amount *
                parseFloat(
                  superDistributorPackage.offline_E_PAN_Card_Commission
                )) /
              100;
          }
        } else {
        ...
        if (
          ...
          if (PAN_Type == "Physical") {
            whiteLableCommAmount =
              (amount *
                parseFloat(whiteLablePackage.offline_P_PAN_Card_Commission)) /
              100;
          } else {
            whiteLableCommAmount =
              (amount *
                parseFloat(whiteLablePackage.offline_E_PAN_Card_Commission)) /
              100;
          }
        } else {
          if (PAN_Type == "Physical") {
            whiteLableCommAmount = parseFloat(
              whiteLablePackage.offline_P_PAN_Card_Commission
            );
          } else {
            whiteLableCommAmount = parseFloat(
              whiteLablePackage.offline_E_PAN_Card_Commission
            );
          }
        }
      }
...
export default SAEPanOfflineHistory;
