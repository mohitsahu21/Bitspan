...
const SASuccessModel = ({ item, setShowSuccessModel, setIsRefresh }) => {
  ...
  //   }
  // };
  const BirthCertificateComm = async (
    retailer,
    distributor,
    superDistributor,
    white_lable,
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.Birth_Certificate_Commission)) /
          100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.Birth_Certificate_Commission
        );
      }
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount *
              parseFloat(distributorPackage.Birth_Certificate_Commission)) /
            100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.Birth_Certificate_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (
          ...
          superDistributorCommAmount =
            (amount *
              parseFloat(
                superDistributorPackage.Birth_Certificate_Commission
              )) /
            100;
        } else {
      ...
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount *
              parseFloat(whiteLablePackage.Birth_Certificate_Commission)) /
            100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.Birth_Certificate_Commission
          );
        }
      }
  ...
  const DeathCertificateComm = async (
    retailer,
    distributor,
    superDistributor,
    white_lable,
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.Death_Certificate_Commission)) /
          100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.Death_Certificate_Commission
        );
      }
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount *
              parseFloat(distributorPackage.Death_Certificate_Commission)) /
            100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.Death_Certificate_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (
          ...
          superDistributorCommAmount =
            (amount *
              parseFloat(
                superDistributorPackage.Death_Certificate_Commission
              )) /
            100;
        } else {
          superDistributorCommAmount = parseFloat(
      ...
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount *
              parseFloat(whiteLablePackage.Death_Certificate_Commission)) /
            100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.Death_Certificate_Commission
          );
        }
      }
  ...
  const ItrRegistrationComm = async (
    retailer,
    distributor,
    superDistributor,
    white_lable,
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.ITR_Registration_Commission)) /
          100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.ITR_Registration_Commission
        );
      }
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount *
              parseFloat(distributorPackage.ITR_Registration_Commission)) /
            100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.ITR_Registration_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (
          ...
          superDistributorCommAmount =
            (amount *
              parseFloat(superDistributorPackage.ITR_Registration_Commission)) /
            100;
        } else {
          superDistributorCommAmount = parseFloat(
            superDistributorPackage.ITR_Registration_Commission
          );
        }
      }
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount *
              parseFloat(whiteLablePackage.ITR_Registration_Commission)) /
            100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.ITR_Registration_Commission
          );
        }
      }
  ...
  const PanFindComm = async (
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.Pan_Find_Commission)) / 100;
      } else {
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount * parseFloat(distributorPackage.Pan_Find_Commission)) / 100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.Pan_Find_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (
          ...
          superDistributorCommAmount =
            (amount * parseFloat(superDistributorPackage.Pan_Find_Commission)) /
            100;
        } else {
          superDistributorCommAmount = parseFloat(
            superDistributorPackage.Pan_Find_Commission
          );
        }
      }
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount * parseFloat(whiteLablePackage.Pan_Find_Commission)) / 100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.Pan_Find_Commission
          );
        }
      }
  ...
  const GSTRegistrationComm = async (
    retailer,
    distributor,
    superDistributor,
    white_lable,
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.GST_Registration_Commission)) /
          100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.GST_Registration_Commission
        );
      }
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount *
              parseFloat(distributorPackage.GST_Registration_Commission)) /
            100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.GST_Registration_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (
          ...
          superDistributorCommAmount =
            (amount *
              parseFloat(superDistributorPackage.GST_Registration_Commission)) /
            100;
        } else {
          superDistributorCommAmount = parseFloat(
            superDistributorPackage.GST_Registration_Commission
          );
        }
      }
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount *
              parseFloat(whiteLablePackage.GST_Registration_Commission)) /
            100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.GST_Registration_Commission
          );
        }
      }
  ...
  const UdyogAadhaarComm = async (
    ...
    try {
      if (retailerPackage.Offline_Services_Commission_Type == "Percentage") {
        retailerCommAmount =
          (amount * parseFloat(retailerPackage.Udyog_Aadhar_Commission)) / 100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.Udyog_Aadhar_Commission
        );
      }
      ...
      if (distributor && distributorPackage) {
        if (
          ...
          distributorCommAmount =
            (amount * parseFloat(distributorPackage.Udyog_Aadhar_Commission)) /
            100;
        } else {
          distributorCommAmount = parseFloat(
            distributorPackage.Udyog_Aadhar_Commission
          );
        }
      }
      if (superDistributor && superDistributorPackage) {
        if (superDistributorPackage.Udyog_Aadhar_Commission == "Percentage") {
          ...
          superDistributorCommAmount = parseFloat(
            superDistributorPackage.Udyog_Aadhar_Commission
          );
        }
      }
      if (white_lable && whiteLablePackage) {
        if (
          ...
          whiteLableCommAmount =
            (amount * parseFloat(whiteLablePackage.Udyog_Aadhar_Commission)) /
            100;
        } else {
          whiteLableCommAmount = parseFloat(
            whiteLablePackage.Udyog_Aadhar_Commission
          );
        }
      }
    ...
    try {
      ...
      if (data.data) {
        ...
        if (item.applicant_select_service == "Birth Certificate") {
          result = await BirthCertificateComm(
            retailer,
            distributor,
            superDistributor,
            white_lable,
          ...
          result = await DeathCertificateComm(
            retailer,
            distributor,
            superDistributor,
            white_lable,
          ...
          result = await ItrRegistrationComm(
            retailer,
            distributor,
            superDistributor,
            white_lable,
          ...
          result = await GSTRegistrationComm(
            retailer,
            distributor,
            superDistributor,
            white_lable,
