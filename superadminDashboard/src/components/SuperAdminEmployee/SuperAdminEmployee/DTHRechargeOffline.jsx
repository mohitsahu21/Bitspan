  ...
  const getPanData = async () => {
    try {
      const { data } = await axios.get(
        "http://localhost:7171/api/auth/superAdminEmployee/getDthConnectionOfflineServices"
      );
      setPanData(data);
    } catch (error) {
      console.log(error);
...
export default DTHRechargeOffline;
