  ...
  const getPanData = async () => {
    try {
      const { data } = await axios.get(
        "http://localhost:7171/api/auth/superAdminEmployee/getAllPanOffline"
      );
      setPanData(data);
    } catch (error) {
      console.log(error);
                                ...
                                <tbody>
                                  {currentRows?.map((patient, index) => {
                                    ...
                                    return (
                                      <tr key={index}>
                                        <td>{patient.id}</td>
                                        <td>{patient.application_type}</td>
                                        <td className="text-capitalize">
                                          {patient.select_title} {patient.name}
                                        </td>
                                        ...
                                        <td>{patient.office_address}</td>
                                        <td>{patient.aadhar_details}</td>
                                        <td>
                                          {
                                            patient.alternative_communication_Address
                                          }
                                        </td>
