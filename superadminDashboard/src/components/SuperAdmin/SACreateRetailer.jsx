                ...
                <div className="main shadow-none ">
                  ...
                  <div className="row g-4 shadow bg-body-tertiary rounded m-4 px-3 pb-3">
                    ...
                    <div className="text-center">
                      <h5>Enter All Correct Details For Creating a Retailer Account</h5>
                    </div>
  ...
  minLength={10}
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                      ...
                      <div class="input-group flex-nowrap">
                        ...
                        <input type="text" id="name" class="form-control" placeholder="User Type" value={"Retailer"} disabled />
                      </div>
                    </div>
                    {/* <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
