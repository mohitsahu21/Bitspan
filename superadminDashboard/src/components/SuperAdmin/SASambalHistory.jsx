    ...
    const fetchOfflineForm = async () => {
      ...
      const filteredItems = users.filter(
        (row) =>{ 
          ...
          (row?.mobile_number && row.mobile_number.toLowerCase().includes(keyword.trim().toLowerCase())) ||
          (row?.family_id && row.family_id.toLowerCase().includes(keyword.trim().toLowerCase())) ||
            (row?.order_id &&
                                    ...
                                    <div className="row shadow-none ">
                                        <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                                <h4 className="mx-lg-5 px-lg-3 px-xxl-5">Sambal Form history</h4>
                                                <p className="mx-lg-5">
                                                    {" "}
                                                    <BiHomeAlt /> &nbsp;/ &nbsp;{" "}
                                                    <span
...
export default SASambalHistory
