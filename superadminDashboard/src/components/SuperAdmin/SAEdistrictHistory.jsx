    ...
    const fetchOfflineForm = async () => {
      ...
      const filteredItems = users.filter(
        (row) =>{ 
          ...
          (row?.mobile_no && row.mobile_no.toLowerCase().includes(keyword.trim().toLowerCase())) || (row?.aadhar_no &&
                             ...
                             mt-5 formdata ">
                                    ...
                                    <div className="row shadow-none ">
                                        <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                                <h4 className="mx-lg-5 px-lg-3 px-xxl-5">E-district-history</h4>
                                                <p className="mx-lg-5">
                                                    {" "}
                                                    <BiHomeAlt /> &nbsp;/ &nbsp;{" "}
                                                    <span
                              ...
                              onChange={(e) => setKeyword(e.target.value)}
                                ...
                                <th scope="col">Application Type</th>
                                  ...
                                  <th scope="col">previous_application</th>
                                  <th scope="col">charge_amount</th>
