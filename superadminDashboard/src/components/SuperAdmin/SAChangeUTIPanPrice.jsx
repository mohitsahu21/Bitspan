                        ...
                        <h3>Raise Complaint</h3>
                                    ...
                                    <div className="row g-4 shadow bg-body-tertiary rounded m-4 px-3">
                                        <div className="text-center my-5">
                                            <h2>Change UTI Physical P Price</h2>
                                        </div>
                                    ...
                                    <div className="row g-4 shadow bg-body-tertiary rounded m-4 mt-5 px-3">
                                        <div className="text-center  my-5">
                                            <h2>Change UTI Physical E Price</h2>
                                        </div>
                                    ...
                                    <div className="row g-4 shadow bg-body-tertiary rounded m-4 mt-5 px-3">
                                        <div className="text-center  my-5">
                                            <h2>Change UTI Digital P Price</h2>
                                        </div>
                                    ...
                                    <div className="row g-4 shadow bg-body-tertiary rounded m-4 mt-5 px-3">
                                        <div className="text-center  my-5">
                                            <h2>Change UTI Digital E Price</h2>
                                        </div>
...
export default SAChangeUTIPanPrice;
