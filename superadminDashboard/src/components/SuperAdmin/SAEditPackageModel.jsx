...
const SAEditPackageModel = ({packages,setEditPackgeDetail,setIsRefresh}) => {
    ...
    verify_edistrict_Certificate_Price : packages.verify_edistrict_Certificate_Price,
      ...
      non_samagra_income_Certificate_Commission : packages.non_samagra_income_Certificate_Commission,
      non_samagra_Domicile_Certificate_Commission : packages.non_samagra_Domicile_Certificate_Commission,
      verify_edistrict_Certificate_Commission : packages.verify_edistrict_Certificate_Commission,
        ...
        Off_Airtel_Postpaid_Recharge_Comm: packages.Off_Airtel_Postpaid_Recharge_Comm,
        ...
        Online_DTH_Recharge_Commission_Type: packages.Online_DTH_Recharge_Commission_Type,
        ...
        On_Sun_Direct_Recharge_Commission: packages.On_Sun_Direct_Recharge_Commission,
        On_Airtel_Dth_Recharge_Commission: packages.On_Airtel_Dth_Recharge_Commission,
        Offline_DTH_Recharge_Commission_Type: packages.Offline_DTH_Recharge_Commission_Type,
        ...
        Off_Sun_Direct_Recharge_Commission: packages.Off_Sun_Direct_Recharge_Commission,
        Off_Airtel_Dth_Recharge_Commission: packages.Off_Airtel_Dth_Recharge_Commission,
        Online_New_DTH_Connection_Commission_Type: packages.Online_New_DTH_Connection_Commission_Type,
        On_Dish_TV_New_DTH_Connection_Commission: packages.On_Dish_TV_New_DTH_Connection_Commission,
        On_Tata_Sky_New_DTH_Connection_Commission: packages.On_Tata_Sky_New_DTH_Connection_Commission,
        On_Videocon_New_DTH_Connection_Commission: packages.On_Videocon_New_DTH_Connection_Commission,
        On_Sun_Direct_New_DTH_Connection_Commission: packages.On_Sun_Direct_New_DTH_Connection_Commission,
        On_Airtel_New_DTH_Connection_Commission: packages.On_Airtel_New_DTH_Connection_Commission,
        Offline_New_DTH_Connection_Commission_Type: packages.Offline_New_DTH_Connection_Commission_Type,
        Off_Dish_TV_New_DTH_Connection_Commission: packages.Off_Dish_TV_New_DTH_Connection_Commission,
        Off_Tata_Sky_New_DTH_Connection_Commission: packages.Off_Tata_Sky_New_DTH_Connection_Commission,
        ...
        Offline_Electricity_Bill_Pay_Commission: packages.Offline_Electricity_Bill_Pay_Commission,
        Online_Insurance_Pay_Commission_Type: packages.Online_Insurance_Pay_Commission_Type,
      ...
      const handlesubmit = async (e) => {
        ...
        try {
          ...
          const response = await axios.put(
            // "http://localhost:7777/api/auth/superAdmin/editPackage",
