...
const SAOnlineRecharges = () => {
 ...
 const { token } = useSelector((state) => state.user);
  ...
  const filteredItems = users.filter(
    (row) =>{ 
      const matchesKeyword =  (row?.created_by_userid &&
      ...
      (row?.UserName && row.UserName.toLowerCase().includes(keyword.trim().toLowerCase())) || (row?.orderid &&
          row.orderid.toLowerCase().includes(keyword.trim().toLowerCase())) || (row?.mobile_no &&
            row.mobile_no.toLowerCase().includes(keyword.trim().toLowerCase()))  || (row?.operator_name &&
                row.operator_name.toLowerCase().includes(keyword.trim().toLowerCase())) || (row?.transaction_id &&
                    row.transaction_id.toLowerCase().includes(keyword.trim().toLowerCase()))  || (row?.providerName &&
                        row.providerName.toLowerCase().includes(keyword.trim().toLowerCase())) 
           
          const matchesType = !rechargeType || rechargeType === "---Select---" || row.recharge_Type === rechargeType;
                                    ...
                                    <div className="row shadow-none">
                                        <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center flex-wrap">
                                                <h4 className="mx-lg-5 px-lg-3 px-xxl-5">Online Recharge History</h4>
                                                <p className="mx-lg-5">
                                                    {" "}
                                                    <BiHomeAlt /> &nbsp;/ &nbsp;{" "}
                                                    <span
...
export default SAOnlineRecharges;
