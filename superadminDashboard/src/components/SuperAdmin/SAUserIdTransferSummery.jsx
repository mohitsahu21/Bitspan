...
const SAUserIdTransferSummery = () => {
  ...
  const fetchShareIdsSummary = async () => {
    setLoading(true);
    try {
      ...
      console.log("API Response Data:", data); // ✅ Step 2: Check API response

      if (data?.success) {
        console.log("Data received:", data.data); // ✅ Step 3: Check fetched data
        setUsers(data.data); // ✅ Set state
      } else {
  ...
  const applyFilters = () => {
    const filtered = users.filter((row) => {
      ...
      const matchesKeyword =
        (row?.senderId && row.senderId.toLowerCase().includes(searchKeyword)) ||
        (row?.receiverId &&
                                ...
                                <table className="table table-striped">
                                  <thead className="table-dark">
                                    <tr>
                                      ...
                                      <th scope="col">ID types</th>
                                      <th scope="col">No of IDs</th>
                                      {/* <th scope="col">
                                        Transaction <br /> Type
                                      </th>
...
export default SAUserIdTransferSummery;
