...
const SAApproveModel = ({ item, setShowApproveModel, amount,packageAmount,setIsRefresh }) => {
  ...
  const fetchActiveUsers = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://2kadam.co.in/api/auth/superAdmin/getSuperAdminWebsiteJoinUsers",
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
    ...
    onChange={(e) => setStatus(e.target.value)}
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title id="packageDetail-modal-sizes-title-lg">Commission Form</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            {selectedItem && <SAApproveModel item={selectedItem} setShowApproveModel={setShowApproveModel} amount = {commissionAmount}
            packageAmount = {packageAmount}  setIsRefresh={setIsRefresh}/>}
          </Modal.Body>
        </Modal>
