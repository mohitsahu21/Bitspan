...
const SdElectricityHistory = () => {
  ...
  const fetchRechargeData = async () => {
    try {
      ...
      console.error("Error fetching Electricity Recharge Data:", error);
      ...
      if (error?.response?.status === 401) {
        ...
        Swal.fire({
          ...
          text: "An error occurred while fetching electricity recharge data. Please try again later.",
        });
      }
    } finally {
      setLoading(false);
...
export default SdElectricityHistory;
