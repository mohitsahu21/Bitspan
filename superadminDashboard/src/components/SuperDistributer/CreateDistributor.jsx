...
const CreateDistributor = () => {
  ...
  const updatedFormData = {
    ...
    userId_type: "Distributor",
  };

  const updateNoOfIds = async () => {
    try {
      const response = await axios.put(
        "http://localhost:7777/api/auth/superDistributor/updateUserProfile",
        updatedFormData,
        {
          headers: {
            "Content-Type": "application/json",
                  ...
                  {remainingIds.remaining_distributor_id > 0 ? (
                    ...
                    <div className="col-sm-12 mt-0">
                      <div className="text-center text-white my-3 py-3 bg-danger">
                        <p className="mb-0">
                          You don't have available distributor IDs to add
                          distributor. Please buy distributor Ids or contact
                          Admin.
                        </p>
                      </div>
                    </div>
