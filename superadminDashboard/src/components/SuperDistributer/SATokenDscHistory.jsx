  ...
  const fetchRechargeData = async () => {
    ...
    try {
      const response = await axios.get(
        ...
        `https://2kadam.co.in/api/auth/superDistributor/getDSCTokenHistory/${userID}`,
        {
          headers: {
...
export default SATokenDscHistory;
