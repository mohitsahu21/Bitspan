...
const SdChangePassword = () => {
  ...
  const handlePasswordChangeRequest = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:7171/api/auth/log-reg/change-password-request`,
        {
          UserId: userID,
  ...
  const handleOtpVerification = async (e) => {
    ...
    try {
      const response = await axios.post(
        `http://localhost:7171/api/auth/log-reg/verify-otp-change-password`,
        {
          UserId: userID,
          otp: otp,
        }
...
export default SdChangePassword;
