                  ...
                  {remainingIds.remaining_retailer_id > 0 ? (
                    ...
                    <div className="col-sm-12 mt-0">
                      <div className="text-center text-white my-3 py-3 bg-danger">
                        <p className="mb-0">
                          You don't have available retailer IDs to add retailer.
                          Please buy retailer Ids or contact Admin.
                        </p>
                      </div>
                    </div>
                  )}
...
export default DCreateDistributor;
