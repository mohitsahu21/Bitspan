  ...
  const fetchRechargeData = async () => {
    ...
    try {
      const response = await axios.get(
        `https://2kadam.co.in/api/auth/retailer/getDSCFormDataforDistributer/${userID}`,
      );
  ...
  const filteredItems = useMemo(() => {
    ...
    return allData.filter((row) => {
      ...
      const matchesKeyword =
        ...
        (row?.mobile && row.mobile.toLowerCase().includes(searchValue)) ||
        (row?.aadhar && row.aadhar.toLowerCase().includes(searchValue));
                    ...
                    <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                      <div className="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <h6 className="mx-lg-5">
                          <BiHomeAlt /> &nbsp;/ &nbsp; Digital Signature History
                        </h6>
                      </div>
                    </div>
                  </div>
