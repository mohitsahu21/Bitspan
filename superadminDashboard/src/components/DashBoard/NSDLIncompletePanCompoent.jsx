...
import NsdlIncomplete from "./NsdlIncomplete";
import NsdlIncompletePanZlink from "./NsdlIncompletePanZlink";
...
const NSDLIncompletePanCompoent = () => {
  const [loading, setLoading] = useState(false);
  const [serviceLoading, setServiceLoading] = useState(false);
  ...
  const renderComponent = () => {
    if (show === "NSDL PAN Instapay") {
      return <NsdlIncomplete />;
    } else if (show === "NSDL PAN ZLink") {
      return <NsdlIncompletePanZlink />;
