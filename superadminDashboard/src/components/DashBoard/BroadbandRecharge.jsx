...
const BroadbandRecharge = () => {
  ...
  const BroadbandRechargeComm = async (
    ...
    try {
      if (
        retailerPackage.Online_Broadband_Bill_Pay_Commission_Type ==
        "Percentage"
      ) {
        retailerCommAmount =
          (amount *
            parseFloat(retailerPackage.Online_Broadband_Bill_Pay_Commission)) /
          100;
      } else {
        retailerCommAmount = parseFloat(
          retailerPackage.Online_Broadband_Bill_Pay_Commission
        );
      }

      if (distributor && distributorPackage) {
        if (
          distributorPackage.Online_Broadband_Bill_Pay_Commission_Type ==
          "Percentage"
        ) {
          distributorCommAmount =
            (amount *
              parseFloat(
                distributorPackage.Online_Broadband_Bill_Pay_Commission
              )) /
            100;
        } else {
      ...
      if (superDistributor && superDistributorPackage) {
        if (
          superDistributorPackage.Online_Broadband_Bill_Pay_Commission_Type ==
          "Percentage"
        ) {
          superDistributorCommAmount =
            (amount *
              parseFloat(
                superDistributorPackage.Online_Broadband_Bill_Pay_Commission
              )) /
            100;
        } else {
      ...
      if (white_lable && whiteLablePackage) {
        if (
          whiteLablePackage.Online_Broadband_Bill_Pay_Commission_Type ==
          "Percentage"
        ) {
          whiteLableCommAmount =
            (amount *
              parseFloat(
                whiteLablePackage.Online_Broadband_Bill_Pay_Commission
              )) /
            100;
        } else {
