...
useEffect(() => {
    if (cleanedEncData) {
      const submitRequest = () => {
        const url = 'https://assisted-service.egov-nsdl.com/SpringBootFormHandling/crPanReq';
        ...
        const formData = {
          reqEntityData: {
            ...
            reqType : cleanedEncData.reqEntityData.reqType,
...
export default RedirectionCorrectionPanForm;