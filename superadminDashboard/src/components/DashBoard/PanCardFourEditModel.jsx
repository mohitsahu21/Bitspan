...
const PanCardFourEditModel = ({ item, setShowMarkEditModel, setIsRefresh }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    previous_attachment_form: item.attachment_form,
    previous_attachment_photo: item.attachment_photo,
  ...
  const handleSubmit = async (e) => {
    ...
    if (attachment_photoRef.current.value) {
      form.append("attachment_photo", files.attachment_photo);
    }

    if (attachment_signatureRef.current.value) {
                  ...
                  <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div className="d-flex justify-content-between align-items-center flex-wrap">
                      ...
                      <h6 className="mx-lg-5">
                        <BiHomeAlt /> &nbsp;/ &nbsp; Edit Pan Card Offline
                      </h6>
                    </div>
                  </div>
                </div> */}
                  ...
                  <form onSubmit={openPinModal}>
                    ...
                    <div className="row">
                      <div className="col-md-12 mb-3">
                        ...
                        />
                        {preveiewfiles.attachment_form && (
                          <a
                            href={preveiewfiles.attachment_form}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            View Existing File
...
export default PanCardFourEditModel;
