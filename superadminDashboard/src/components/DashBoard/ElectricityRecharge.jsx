...
const ElectricityRecharge = () => {
  ...
  const operatorOptions = [
    ...
    {
      name: "M.P. Poorv Kshetra Vidyut Vitaran Company Ltd (URBAN)",
      value: "M.P. Poorv Kshetra Vidyut Vitaran Company Ltd (URBAN)",
    },
    {
  ...
  const ElectricityRechargeComm = async (
    ...
    const retailerFormData = {
      userId: currentUser.userId,
      amount: "",
      Transaction_details: `Commission Credit for Electricity`,
      status: "Success",
      Order_Id,
      Transaction_Id,
    };
    ...
    for (const api of apiData) {
      ...
      try {
        ...
        if (
          ...
          result.distributorFormData.Transaction_details = `Commission Credit for Electricity Order Id ${rechargeResult.data.orderId}`;
          result.superDistributorFormData.Transaction_details = `Commission Credit for Electricity Order Id ${rechargeResult.data.orderId}`;
          result.whiteLableFormData.Transaction_details = `Commission Credit for Electricity Order Id ${rechargeResult.data.orderId}`;
          if (
            result &&
