...
import UTIRetailerIdActivate from "./UTIRetailerIdActivate";
import UTIRetailerIdActivateZlink from "./UTIRetailerIdActivateZlink";
...
const UTIRetailerIdActivateComponent = () => {
    const [loading, setLoading] = useState(false);
    const [serviceLoading, setServiceLoading] = useState(false);
      ...
      const findActiveService = () => {
        ...
        if (services.length > 0) {
          const activeService = services.find((item) => 
            ["UTI PAN Zlink", "UTI PAN Easysmart"].includes(item.service_name) &&
            item.status === "Active"
          );
    ...
    const renderComponent = () => {
        ...
        return <UTIRetailerIdActivateZlink />;
      } else if (show === "UTI PAN Easysmart") {
        return  <UTIRetailerIdActivate />;
        ...
        return <div className="d-flex justify-content-center p-4"><h4>UTI PAN service is currently Not Available <br></br>Please try after some time</h4></div>;
      }
    };
