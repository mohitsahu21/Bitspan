                          ...
                          <p className="">
                            ...
                            <div className="col-sm-12">
                              ...
                              <div class="input-group flex-nowrap">
                                ...
                                <input type="text" id="name" value={"Mohit24501"} disabled class="form-control" placeholder="Enter User Id" />
                              </div>
                            </div>
                            <div className="col-sm-12">
                              ...
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaUser /></span>
                                <input type="text" id="name" value={"Mohit Sahu"} disabled class="form-control" placeholder="Enter Customer Name" />
                              </div>
                            </div>
                            <div className="col-sm-12">
                              <label for="name" class="form-label">NSDL Phycial PAN Price</label>
                              <div class="input-group flex-nowrap">
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">NSDL E-PAN Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">UTI Physical P Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">UTI Physical E Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">UTI Digital P Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">UTI Digital E Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                            ...
                            <div className="col-sm-12">
                              <label for="name" class="form-label">UTI New Coupon Price</label>
                              <div class="input-group flex-nowrap">
                                <span class="input-group-text" id="addon-wrapping"> <FaRupeeSign /></span>
                                <input type="text" id="name" class="form-control" placeholder="Enter UTI New Coupon Price" />
                              </div>
                            </div>
                          ...
                          <div class="form-floating">
                            ...
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                              <div className="text-start mb-3">
                                <button className="btn p-2 px-3">Change Price</button>
                              </div>
                            </div>
                          </div>
                        </div>
