...
const LogoAndImages = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    Object.entries(formData).forEach(([key, value]) => {
      if (
        key !== "Home_Page_Background_Preview" &&
        key !== "Logo_Preview" &&
        key !== "Fav_Icon_Preview" &&
        key !== "Signature_With_Stamp_Preview"
      ) {
        // Exclude the preview URL and id from submission
        formDataSend.append(key, value);
        console.log(key, value);
                    ...
                    {loading ? (
                      ...
                      <>
                        ...
                        {/* <div className="col-sm-12 mb-5">
                          ...
                          <div>
                            <img
                              src={formData.Home_Page_Background_Preview}
                              width={600}
                              height={100}
                              className="img-fluid"
                            />
                        ...
                        <div className="col-sm-12 mb-5">
                          ...
                          <span className="text-danger">
                            {" "}
                            {errors["Fav_Icon"] && (
                              <div className="error">{errors["Fav_Icon"]}</div>
                            )}
                          </span>
                        </div>
                        <div className="col-sm-12">
                          <label for="name" class="form-label">
                            Upload To Change Signature With Stamp (200 X 58)px -
                            PNG Only
                          </label>
                          <div>
                            <img
                              src={formData.Signature_With_Stamp_Preview}
                              width={200}
                              height={58}
                              className="img-fluid"
                            />
